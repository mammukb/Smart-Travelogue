...
public class Cust_service extends ArrayAdapter<String> {
    ...
    public Cust_service(View_services context, String[] type, String[] f_name, String[] f_place, String[] city, String[] state, String[] phone, String[] email, String[] photo,String[] lati,String[] longi) {
