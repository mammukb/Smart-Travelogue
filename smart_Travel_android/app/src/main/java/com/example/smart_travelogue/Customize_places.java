...
public class Customize_places extends ArrayAdapter<String>  {

    private Activity context;
    SharedPreferences sh;
    private String[] place_id, place, city,lmark,state,lati,longi;
    ...
    public Customize_places(View_places context, String[] place_id, String[] place, String[] city, String[] lmark, String[] state, String[] lati, String[] longi) {
        super(context, R.layout.activity_customize_places, place_id);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_customize_places, null, true);
...
//
    ...
    public void setAdapter(Customize_places drg) {
    }
}