...
public class Custome_Travelogue extends ArrayAdapter<String>  {
    ...
    public Custome_Travelogue(View_travelogue context, String[] travelogue_id, String[] title, String[] desc) {
        super(context, R.layout.activity_custome_travelogue, travelogue_id);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_custome_travelogue, null, true);
...
//                String tt = travelogue_id[pos];
//                SharedPreferences.Editor editor = context.getSharedPreferences("YourPrefsName", Context.MODE_PRIVATE).edit();
//                editor.putString("travel", tt);
//                editor.apply();
                trav_id = travelogue_id[position]; // Store the travelogue_id value at the clicked position

                // Storing trav_id in SharedPreferences
                SharedPreferences.Editor editor = context.getSharedPreferences("YourPrefsName", Context.MODE_PRIVATE).edit();
                editor.putString("travel", trav_id);
                editor.apply();
                Intent in = new Intent(context.getApplicationContext(), view_media.class);
