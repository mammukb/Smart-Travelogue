...
public class view_others_traveloge extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_others_traveloge);
        lv = findViewById(R.id.li);
        lv.setOnItemClickListener(this);
        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        JsonReq JR = new JsonReq();
        JR.json_response = (JsonResponse) view_others_traveloge.this;
        String q = "/View_other_travelogue?login=" + sh.getString("login_id","");
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
...
//                lv.setAdapter(ar);
                ...
                view_others_custom_traveloge ll = new view_others_custom_traveloge(view_others_traveloge.this,travelogue_id,title,desc);
                lv.setAdapter(ll);
